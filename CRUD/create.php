        ...
        <form action="save.php" method="post" enctype="multipart/form-data" class="grid grid-cols-2 gap-6">
            ...
            <div class="flex flex-col space-y-3">
                ...
                <div class="flex flex-col  ">
                    ...
                    <input type="text" name="no_telepon" id="no_telepon" class="border border-gray-300 rounded-md p-2 mb-4">
                </div>
                <div class="flex flex-col   ">
                    <div class=" ">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div id="gambar-tambahan-container" class="space-y-3">
                        <div class="flex items-center">
                            <input type="file" name="gambar_tambahan[]" accept=".jpg, .jpeg, .png" class="border border-gray-300 rounded-md p-2">
                        </div>
                    </div>
                ...
                <div class="flex flex-col mt-4 gap-4">
                    <div class="flex flex-col mr-6 ">
                        ...
                        <input type="number" id="latitude" step="any" name="latitude" required class="border border-gray-300 rounded-md p-2">
                    </div>
                    <div class="flex flex-col mr-6">
                        <label for="longitude" class="font-semibold   mb-2">Longitude:</label>
                        <input type="number" id="longitude" step="any" name="longitude" required class="border border-gray-300 rounded-md p-2">
                    </div>
                    <div class="flex flex-col mr-6">
                        <label for="google_maps_link" class="font-semibold mb-2">Google Maps Link:</label>
                        <input type="text" id="google_maps_link" name="google_maps_link"   class="border border-gray-300 rounded-md p-2 bg-gray-100">
                    </div>
                </div>
            </div>
            ...
            <select name="jarakuniversitas" id="jarakuniversitas" required class="border border-gray-300 rounded-md p-2" onchange="updateDistance()">
                <option value="1" data-lat="5.177828" data-lng="97.093544">Universitas Malikussaleh</option>
